            ...
            <section className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 md:text-base">
                  ...
                  inspect previous findings,
                  and confirm pending reports
                  before they are shown to patients.
            ...
            {loading ? (
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-10 text-center shadow-sm">
                ...
                <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-slate-500 md:text-base">
                  ...
                  There are currently no matching reports available.
                  Once scan analysis and report generation are completed,
