...
DETECTION RESULT:
${report.hasStones
  ? `⚠️ Stone Detected — ${report.stoneCount} stone(s) found`
  : '✅ No Stone Detected'}
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="mt-3 space-y-2 text-sm text-slate-600">
                      ...
                      <p>
                        ...
                        {report.doctorConfirmed ? '✅ Confirmed' : '⏳ Pending'}
                      </p>
                      {report.hasStones && (
                        <p>
                          <span className="font-semibold text-slate-900">
                ...
                {report.finalDiagnosis && (
                  <div className="mt-4 rounded-2xl border-l-4 border-purple-500 bg-purple-50 p-4">
                    <p className="text-sm font-bold text-purple-800">Final Diagnosis</p>
                ...
                {report.followUp && (
                  <div className="mt-4 rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4">
                    <p className="text-sm font-bold text-emerald-800">Follow-Up Plan</p>
                    <p className="mt-1 text-sm leading-6 text-slate-600">
                      {report.followUp}
                    </p>
                  </div>
